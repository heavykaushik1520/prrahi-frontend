        ...
        <Card className="p-4 privacy-policy-card">
          <Card.Body>
            ...
            <p className="policy-intro">
              VAAPS, i.e., M/s. VAAPS Enterprise, a Guwahati-based partnership
              firm in the segment of dealing and marketing with Joss sticks,
              incense sticks, and other incense products under its brand name
              “PRRAHI Agarbatti,” which is a registered Trademark, is committed
              to protecting your privacy. This Privacy Policy outlines how VAAPS
              collects, uses, and safeguards your personal information on its
              website, www.prrahi.in. By accessing or using our services, you
            ...
            <section className="policy-section" id="section-1">
              <h2 className="section-heading">
                SECTION 1 – KYC (Know your customer): What do we do with your
                information?
              </h2>
              <p>
                When you purchase products from our store, as part of the buying
                and selling process, we collect the personal information you
                give us, such as your **name**, **address**, **contact
              ...
              <p>
                **Email marketing (if applicable):** With your permission, we
                may send you emails, messages, texts over WhatsApp, etc., about
            ...
            <section className="policy-section" id="section-2">
              ...
              <p>
                ...
                to us collecting that data and using it for that specific reason
                only.
              </p>
              <p>
              ...
              <p>
                ...
                contacting us at **+91 99540 22020** or mailing us at:
              </p>
              <address>
            ...
            <section className="policy-section" id="section-4">
              ...
              <p>
                We use <b>Razorpay</b> as our payment gateway for processing
                payments. We do not store your credit card or other payment
                instrument details on our servers.
              </p>
              <p>
                Razorpay may collect and process your payment information, such
                as card details or UPI information, in accordance with the{" "}
                <b>Payment Card Industry Data Security Standard (PCI-DSS)</b>.
                Razorpay ensures that all sensitive transaction data is
                encrypted and handled securely.. For more insight, you may also
                read Terms of Service of VAAPS.
              </p>
              <p>
                Your purchase transaction data is used only as long as necessary
                to complete your transaction. Once completed, your payment
                information is not stored by us and is handled in accordance
                with Razorpay’s own privacy policy.
              </p>
            </section>
            ...
            <section className="policy-section" id="section-5">
              ...
              <p>
                ...
                policies so that you can understand the manner in which your
                personal information will be handled by these providers. In
                particular, it shall be remembered that certain providers may be
                located in or have facilities that are located in a different
              ...
              <p>
                ...
                legislation, including the Patriot Act. Once you leave our
              ...
              <p>
                {" "}
                <a
                  href="https://prrahi.in/terms-of-service"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  www.prrahi.in/terms-of-service
                </a>
              </p>
              <p>
            ...
            <section className="policy-section" id="section-6">
              ...
              <p>
                ...
                precautions and follow industry best practices to make sure that
                the same are not inappropriately lost, misused, accessed,
                disclosed, altered, or destroyed.
              </p>
              <p>
                If you provide us with your credit card information, the
                information shall remain encrypted using **secure socket layer
                technology (SSL)** and stored with an **AES-256 encryption**.
                Although no method of transmission over the Internet or
                electronic storage is 100% secure, we follow all PCI-DSS
                requirements and implement additional standards which are
            ...
            <section className="policy-section" id="section-8">
              ...
              <p>
                By using this site, you represent that you have at least
                attained the **age of majority** in your state or province of
            ...
            <section className="policy-section" id="section-10">
              ...
              <p>
                ...
                Officer at **+91 99540 22020** or by mailing us at:
              </p>
              <address>
                M/s. VAAPS Enterprise <br />
                Building No. 1, Ground Floor, Sikaria Compound <br />
