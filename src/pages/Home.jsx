        ...
        <div className="container mt-4">
          <div className="container mt-4">
            ...
            <p className="lead poppins-regular">
              ...
              transformation. In today’s fast-paced world, we all long for
              moments of calm, clarity, and emotional balance. That’s where{" "}
            ...
            <p className="lead poppins-regular">
              ...
              deepening your meditation practice, or simply creating a serene
              home environment, PrRaHi fills your space with{" "}
            ...
            <ul className="text-justify poppins-medium">
              ...
              <li>
                Available in soothing floral, woody, and traditional blends
              </li>
